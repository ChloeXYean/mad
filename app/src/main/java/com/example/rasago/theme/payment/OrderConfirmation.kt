    ...
    Surface {
        Column(
            ...
            Row(
                ...
                Button(onClick = { /*TODO: Implement proceed action*/ }, colors = ButtonDefaults.buttonColors(containerColor = Color.Green)) {
                    Text(text = "Proceed", color = Color.White)
                }
                Button(onClick = { /*TODO: Implement cancel action*/ }, colors = ButtonDefaults.buttonColors(containerColor = Color.Red)) {
