...
// Repository = bridge between DAO (database layer) and ViewModel (UI/app logic)
@Singleton
class OrderRepository @Inject constructor(
    ...
    suspend fun getOrderWithItems(orderId: Long): Order? = withContext(Dispatchers.IO) {
        orderDao.getOrderWithItems(orderId)?.toOrder()
    }

    suspend fun insertOrder(orderEntity: OrderEntity, orderItems: List<OrderItemEntity>): Long =
